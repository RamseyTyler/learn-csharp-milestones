...
- [x] ✏️ Open the reference manual for any component from inside Unity. Paste the link: **https://learn.microsoft.com/en-us/dotnet/csharp/tour-of-csharp/overview**
...
- [x] ✏️ Search for the `Strings` class in [Microsoft's C# documents](https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/). Paste the link: **https://learn.microsoft.com/en-us/dotnet/csharp/how-to/search-strings**
...
- [x] Update Assets/Scripts/LearningCurve.cs
	...
	- [x] Colletions
		- [x] ✏️ What will `arr[1]` return from this array `int[] arr = {'red','green','blue'};` ? : **arr[1] will return 'green' since arrays begin counting at the 0 index value making the index value of [1] the second iteration in the above array.**
