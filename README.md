...
- [x] ✏️ Open the reference manual for any component from inside Unity. Paste the link: **??**
- [x] ✏️ Find the button to jump to the scripting reference the any reference manual page. Paste the link: **??**
- [x] ✏️ Search for the `Strings` class in [Microsoft's C# documents](https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/). Paste the link: **??**
